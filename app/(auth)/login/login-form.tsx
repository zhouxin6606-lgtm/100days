...
export function LoginForm({
  ...
  // We need to handle searchParams synchronously for the error display
  // Since this is a client component, we'll use a simple approach
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      >
        {pending ? UI_TEXT.common.loading : UI_TEXT.auth.login}
      </button>
    </form>
  );
}
