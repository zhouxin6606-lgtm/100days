    ...
    <div className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
      ...
      <form action={formAction} className="space-y-3">
        ...
        <input
          name="name"
          required
          placeholder={UI_TEXT.group.groupName}
        ...
        <input
          name="description"
          placeholder={UI_TEXT.group.description}
          className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 placeholder-zinc-400 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
        />
        <button
          type="submit"
          disabled={pending}
          className="w-full rounded-lg bg-emerald-600 px-3 py-2 text-sm font-medium text-white hover:bg-emerald-700 disabled:opacity-50 dark:bg-emerald-500 dark:hover:bg-emerald-600"
        >
          {pending ? UI_TEXT.common.loading : UI_TEXT.group.create}
        </button>
      </form>
    </div>
  );
